 ...
 */
exports.menu = function(opts_string_ip, opts_string_port, opts_string_cli_port, opts_string_name, opts_string_remote_url, cb) {
  var returnMenu = configMessages.menu;
  returnMenu.contents[2].value = opts_string_ip;
  returnMenu.contents[3].value = opts_string_port;  
  returnMenu.contents[4].value = opts_string_cli_port;  
  returnMenu.contents[5].value = opts_string_name;
  returnMenu.contents[6].value = opts_string_remote_url;
...
exports.echo = function(opts,params,cb) {
  ...
  opts.lmscliport = params.lmscliport;
  ...
  if (payloadToSend.contents[1]) {
      ...
      payloadToSend.contents[4].text = "CLI Port: "+params.lmscliport;
      payloadToSend.contents[5].text = "Name: "+params.lmsname;
      payloadToSend.contents[6].text = "Remote URL: "+params.remote_url;
  } else {
  	  // no response string
    ...
    payloadToSend.contents.push({ "type": "paragraph", "text": "CLI Port: "+params.lmscliport });
